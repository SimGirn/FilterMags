...
def test_read_spectrum():
    ...
    spectrumfile0 = os.path.join(current_dir, 'Tutorial/TestData/spec-5164-56067-0822.fits')
    wave0, flux0 = filtermag.read_spectrum(spectrumfile0)
    assert len(wave0) == len(flux0)

    spectrumfile1 = os.path.join(current_dir, 'Tutorial/TestData/spec1-1678-53433-0425.fits')
    wave1, flux1 = filtermag.read_spectrum(spectrumfile1)
    assert len(wave1) == len(flux1)

    spectrumfile2 = os.path.join(current_dir, 'Tutorial/TestData/spec2-1678-53433-0429.fits')
...
class TestWithErrors(unittest.TestCase):
    ...
    def test_out_of_range(self):
        ...
        """
        current_dir = os.getcwd()
        spectrumfile = os.path.join(current_dir, 'Tutorial/TestData/spec-5164-56067-0822.fits')
